        ...
        <nav class="navbar navbar-expand-sm navbar-dark position-relative">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?=URL?>/pagina/sobre" data-tooltip="tooltip" title="Sobre nós">Sobre nós</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=URL?>/pagina/contato" data-tooltip="tooltip" title="Sobre nós">Contato</a>
                    </li>
                </ul>
            </div>
